...
class Client(models.Model):
    ...
    project_ids = models.ForeignKey('Project', on_delete=models.DO_NOTHING, null=True, blank=True)
    contact_ids = models.ForeignKey('Client', on_delete=models.DO_NOTHING, null=True, blank=True)
